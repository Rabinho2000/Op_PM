...
672 testes automatizados de backend a passar (+3 skipped) em SQLite (e em
PostgreSQL, ver abaixo) + 230 testes Vitest no frontend. Sem integrações
...
[`docs/DATA_IMPORTS.md`](docs/DATA_IMPORTS.md). 672 testes de backend
(+3 skipped) e 230 testes Vitest no frontend.
