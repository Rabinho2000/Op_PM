...
579 testes automatizados de backend a passar (+2 skipped) em SQLite (e em
PostgreSQL, ver abaixo) + 172 testes Vitest no frontend. Sem integrações
...
[`docs/DATA_IMPORTS.md`](docs/DATA_IMPORTS.md). 579 testes de backend
(+2 skipped) e 172 testes Vitest no frontend.
